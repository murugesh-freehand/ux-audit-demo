...
export const lanes: Lane[] = [
  { id: 'l1', contractId: 'avrt-c2', mode: 'LTL', type: 'Contracted', ref: 'AV-001', origin: { city: 'Kenosha', state: 'WI', country: 'US' }, destination: { city: 'Atlanta', state: 'GA', country: 'US' }, discount: 68.5, service: 'Standard', validFrom: '2026-01-01', validTo: '2026-12-31', status: 'ACTIVE' },
  { id: 'l2', contractId: 'avrt-c2', mode: 'LTL', type: 'Contracted', ref: 'AV-002', origin: { city: 'Chicago', state: 'IL', country: 'US' }, destination: { city: 'Nashville', state: 'TN', country: 'US' }, discount: 71.0, service: 'Standard', validFrom: '2026-01-01', validTo: '2026-12-31', status: 'ACTIVE' },
  { id: 'l3', contractId: 'avrt-c2', mode: 'LTL', type: 'Contracted', ref: 'AV-003', origin: { city: 'Memphis', state: 'TN', country: 'US' }, destination: { city: 'Dallas', state: 'TX', country: 'US' }, discount: 65.0, service: 'Standard', validFrom: '2026-01-01', validTo: '2026-12-31', status: 'ACTIVE' },
  { id: 'l4', contractId: 'avrt-c2', mode: 'LTL', type: 'Contracted', ref: 'AV-004', origin: { city: 'Charlotte', state: 'NC', country: 'US' }, destination: { city: 'Miami', state: 'FL', country: 'US' }, discount: 72.5, service: 'Standard', validFrom: '2026-01-01', validTo: '2026-12-31', status: 'ACTIVE' },
  { id: 'l5', contractId: 'avrt-c2', mode: 'LTL', type: 'Contracted', ref: 'AV-005', origin: { city: 'Indianapolis', state: 'IN', country: 'US' }, destination: { city: 'Louisville', state: 'KY', country: 'US' }, discount: 69.0, service: 'Priority', validFrom: '2026-01-01', validTo: '2026-12-31', status: 'ACTIVE' },
  { id: 'l6', contractId: 'avrt-c2', mode: 'LTL', type: 'Contracted', ref: 'AV-006', origin: { city: 'St. Louis', state: 'MO', country: 'US' }, destination: { city: 'Kansas City', state: 'MO', country: 'US' }, discount: 70.0, service: 'Standard', validFrom: '2026-01-01', validTo: '2026-12-31', status: 'ACTIVE' },
  { id: 'l7', contractId: 'avrt-c2', mode: 'LTL', type: 'Contracted', ref: 'AV-007', origin: { city: 'Detroit', state: 'MI', country: 'US' }, destination: { city: 'Columbus', state: 'OH', country: 'US' }, discount: 67.5, service: 'Standard', validFrom: '2026-01-01', validTo: '2026-12-31', status: 'ACTIVE' },
  { id: 'l8', contractId: 'avrt-c2', mode: 'LTL', type: 'Contracted', ref: 'AV-008', origin: { city: 'Philadelphia', state: 'PA', country: 'US' }, destination: { city: 'Baltimore', state: 'MD', country: 'US' }, discount: 73.0, service: 'Standard', validFrom: '2026-01-01', validTo: '2026-12-31', status: 'ACTIVE' },
  { id: 'l9', contractId: 'avrt-c2', mode: 'LTL', type: 'Contracted', ref: 'AV-009', origin: { city: 'Cincinnati', state: 'OH', country: 'US' }, destination: { city: 'Pittsburgh', state: 'PA', country: 'US' }, discount: 66.0, service: 'Standard', validFrom: '2026-01-01', validTo: '2026-12-31', status: 'ACTIVE' },
  { id: 'l10', contractId: 'avrt-c2', mode: 'LTL', type: 'Contracted', ref: 'AV-010', origin: { city: 'Houston', state: 'TX', country: 'US' }, destination: { city: 'San Antonio', state: 'TX', country: 'US' }, discount: 74.0, service: 'Priority', validFrom: '2026-01-01', validTo: '2026-12-31', status: 'ACTIVE' },
  { id: 'l11', contractId: 'fxfe-c1', mode: 'LTL', type: 'Contracted', ref: 'FX-001', origin: { city: 'Memphis', state: 'TN', country: 'US' }, destination: { city: 'Chicago', state: 'IL', country: 'US' }, discount: 62.0, service: 'Standard', validFrom: '2026-01-01', validTo: '2026-12-31', status: 'ACTIVE' },
  { id: 'l12', contractId: 'fxfe-c1', mode: 'LTL', type: 'Contracted', ref: 'FX-002', origin: { city: 'Los Angeles', state: 'CA', country: 'US' }, destination: { city: 'Phoenix', state: 'AZ', country: 'US' }, discount: 58.5, service: 'Standard', validFrom: '2026-01-01', validTo: '2026-12-31', status: 'ACTIVE' },
];
