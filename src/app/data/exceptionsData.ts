...
export const exceptions: AuditException[] = [
  // RATE_UNAVAILABLE — 3 open
  {
    ...
    chargeCode: 'DSC', code: 'RATE_UNAVAILABLE', status: 'OPEN', variance: null, date: '2026-05-05',
  },
  {
    ...
    chargeCode: 'ENS', code: 'RATE_UNAVAILABLE', status: 'OPEN', variance: null, date: '2026-05-05',
  },
  {
    ...
    chargeCode: '400', code: 'RATE_UNAVAILABLE', status: 'OPEN', variance: null, date: '2026-05-05',
  },
  // RATE_UNAVAILABLE — resolved
  {
    ...
    chargeCode: 'FSC', code: 'RATE_UNAVAILABLE', status: 'RESOLVED', variance: null, date: '2026-04-28', resolvedBy: 'cfo@example.com',
  },
  {
  ...
  },
  {
    ...
    chargeCode: 'BASE', code: 'RATE_UNAVAILABLE', status: 'RESOLVED', variance: null, date: '2026-04-15', resolvedBy: 'cfo@example.com',
  },
  // CROSS_DOC_MISMATCH
  {
    ...
    chargeCode: 'WT', code: 'CROSS_DOC_MISMATCH', status: 'RESOLVED', variance: null, date: '2026-04-15', resolvedBy: 'cfo@example.com',
  },
  // BUSINESS_RULE
  {
    ...
    chargeCode: 'OHC', code: 'BUSINESS_RULE', status: 'RESOLVED', variance: 7.00, date: '2026-04-15', resolvedBy: 'cfo@example.com',
  },
  // Invoice INV-2026-00441 open exceptions
  {
    ...
    chargeCode: 'BASE', code: 'RATE_UNAVAILABLE', status: 'OPEN', variance: 310.00, date: '2026-04-30',
  },
  {
    ...
    chargeCode: 'INSURANCE', code: 'BUSINESS_RULE', status: 'OPEN', variance: 137.50, date: '2026-04-30',
  },
];
